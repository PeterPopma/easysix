...
public class DiscloseType {
    ...
    protected List<IntLocType> name;
    protected List<IntLocType> org;
    protected List<IntLocType> addr;
     ...
     * 
     */
    public List<IntLocType> getName() {
        if (name == null) {
            name = new ArrayList<IntLocType>();
        }
        return this.name;
    }
     ...
     * 
     */
    public List<IntLocType> getOrg() {
        if (org == null) {
            org = new ArrayList<IntLocType>();
        }
        return this.org;
    }
     ...
     * 
     */
    public List<IntLocType> getAddr() {
        if (addr == null) {
            addr = new ArrayList<IntLocType>();
        }
        return this.addr;
    }
