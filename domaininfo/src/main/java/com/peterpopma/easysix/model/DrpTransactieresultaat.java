...
/**
 * The persistent class for the DRP_TRANSACTIERESULTAAT database table.
 * 
 */
@Entity
@Table(name="DRP_TRANSACTIERESULTAAT")
@NamedQuery(name="DrpTransactieresultaat.findAll", query="SELECT d FROM DrpTransactieresultaat d")
public class DrpTransactieresultaat implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@Column(name="TRT_ID", unique=true, nullable=false, precision=15)
	private long trtId;
