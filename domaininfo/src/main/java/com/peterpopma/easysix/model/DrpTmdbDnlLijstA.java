...
/**
 * The persistent class for the DRP_TMDB_DNL_LIJST_A database table.
 * 
 */
@Entity
@Table(name="DRP_TMDB_DNL_LIJST_A")
@NamedQuery(name="DrpTmdbDnlLijstA.findAll", query="SELECT d FROM DrpTmdbDnlLijstA d")
public class DrpTmdbDnlLijstA implements Serializable {
