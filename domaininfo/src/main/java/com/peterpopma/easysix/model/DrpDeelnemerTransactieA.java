...
/**
 * The persistent class for the DRP_DEELNEMER_TRANSACTIE_A database table.
 * 
 */
@Entity
@Table(name="DRP_DEELNEMER_TRANSACTIE_A")
@NamedQuery(name="DrpDeelnemerTransactieA.findAll", query="SELECT d FROM DrpDeelnemerTransactieA d")
public class DrpDeelnemerTransactieA implements Serializable {
	...
	@Column(name="DNT_ID", precision=12)
	private BigDecimal dntId;
	...
	public DrpDeelnemerTransactieA() {
	}
	...
	public BigDecimal getDntId() {
		return this.dntId;
	}

	public void setDntId(BigDecimal dntId) {
		this.dntId = dntId;
	}
