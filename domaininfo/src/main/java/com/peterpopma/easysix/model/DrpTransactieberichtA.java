...
/**
 * The persistent class for the DRP_TRANSACTIEBERICHT_A database table.
 * 
 */
@Entity
@Table(name="DRP_TRANSACTIEBERICHT_A")
@NamedQuery(name="DrpTransactieberichtA.findAll", query="SELECT d FROM DrpTransactieberichtA d")
public class DrpTransactieberichtA implements Serializable {
	...
	@Column(name="TBT_ID", precision=12)
	private BigDecimal tbtId;
	...
	@Column(name="TRT_CODE", length=10)
	...
	public BigDecimal getTbtId() {
		return this.tbtId;
	}

	public void setTbtId(BigDecimal tbtId) {
		this.tbtId = tbtId;
	}
