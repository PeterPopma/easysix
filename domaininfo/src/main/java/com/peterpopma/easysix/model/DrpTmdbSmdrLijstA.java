...
/**
 * The persistent class for the DRP_TMDB_SMDR_LIJST_A database table.
 * 
 */
@Entity
@Table(name="DRP_TMDB_SMDR_LIJST_A")
@NamedQuery(name="DrpTmdbSmdrLijstA.findAll", query="SELECT d FROM DrpTmdbSmdrLijstA d")
public class DrpTmdbSmdrLijstA implements Serializable {
