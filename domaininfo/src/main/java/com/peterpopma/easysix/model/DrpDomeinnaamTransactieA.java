...
/**
 * The persistent class for the DRP_DOMEINNAAM_TRANSACTIE_A database table.
 * 
 */
@Entity
@Table(name="DRP_DOMEINNAAM_TRANSACTIE_A")
@NamedQuery(name="DrpDomeinnaamTransactieA.findAll", query="SELECT d FROM DrpDomeinnaamTransactieA d")
public class DrpDomeinnaamTransactieA implements Serializable {
	...
	@Column(name="DNE_ID", precision=12)
	private BigDecimal dneId;
	...
	public DrpDomeinnaamTransactieA() {
	}
	...
	public BigDecimal getDneId() {
		return this.dneId;
	}

	public void setDneId(BigDecimal dneId) {
		this.dneId = dneId;
	}
